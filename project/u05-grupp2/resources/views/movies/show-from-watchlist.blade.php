...
<div class="container card pt-2 p-3" >
        <div class="row text-center mt-3 d-flex justify-content-center align-items-center">
            <div class="col-sm">
                ...
                <ul class="list-group list-group-horizontal d-flex justify-content-center align-items-center">
                    <li class="list-group-item text-primary">{{ $movie->year }}</li>
                    <li class="list-group-item text-primary">{{ $movie->public }}</li>
        ...
        <div class="row mt-3">
            <div class="col-sm">
                <ul class="list-group list-group-horizontal d-flex justify-content-center align-items-center">
                    <li class="list-group-item text-primary">{{ $movie->category }}</li>
                </ul> 
               <div class="mt-4">
                   <p>
                       {{ $movie->description }}
